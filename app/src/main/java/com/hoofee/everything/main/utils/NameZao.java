...
public class NameZao {
     ...
     * @return
     */
    private static String generateFirstName(int s) {
    ...
    public static String generateManyNames(int i, int s, String sname) {
        StringBuffer manyNames = new StringBuffer("");
        //yyd修改过的
        if (i > 0) {
            for (int j = 0; j < i; j++) {
                if (sname == "false") {
                    //System.out.println(generateLastName()+generateFirstName(2));
                    manyNames.append(generateLastName() + generateFirstName(s)).append("      ");
                } else {
                    manyNames.append(sname + generateFirstName(s)).append("      ");
                }
            }
        }
     ...
     * @return
     */
    public static String getNames(int cour, int sex, String name) {
        return generateManyNames(cour, sex, name);
    }
    ...
    public static String getName() {
        return generateLastName() + generateFirstName(2);
    }
}
